...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String icon, int reportsCount});
}
...
class _$CategoryModelImpl implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, icon: $icon, reportsCount: $reportsCount)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, icon, reportsCount);
